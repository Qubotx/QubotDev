...
class Controller:
    ...
    def set_accel_time(self, L_ms, R_ms):
        ...
        result = self.client.write_registers(
            self.L_ACL_TIME, [int(L_ms), int(R_ms)], self.ID
        )
    ...
    def set_decel_time(self, L_ms, R_ms):
        ...
        result = self.client.write_registers(
            self.L_DCL_TIME, [int(L_ms), int(R_ms)], self.ID
        )
    ...
    def set_rpm(self, L_rpm, R_rpm):
        ...
        result = self.client.write_registers(
            self.L_CMD_RPM, [left_bytes, right_bytes], self.ID
        )
        return result
    ...
    def set_maxRPM_pos(self, max_L_rpm, max_R_rpm):
        ...
        result = self.client.write_registers(
            self.L_MAX_RPM_POS, [int(max_L_rpm), int(max_R_rpm)], self.ID
        )
    ...
    def set_relative_angle(self, ang_L, ang_R):
        ...
        result = self.client.write_registers(
            self.L_CMD_REL_POS_HI, all_cmds_array, self.ID
        )
